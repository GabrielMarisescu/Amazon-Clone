    ...
    return (
        <div className="login">
            ...
            <div className="login__container">
                ...
                <button className="login__signInButton" type="submit" onClick={signIn}> Continua</button>

                </form>
                <p>Questa è una copia di AMAZON. </p>
                <button onClick={register} className="login__registerButton"> Crea il tuo account Amazon</button>
